...
const WhatMakesUsDifferent = () => {
  return (
    <div className="w-full h-fit bg-gray-200 border-t-2 border-green-dark py-10 sm:px-5 sm:py-16 lg:container mx-auto">
      <div className="flex flex-col gap-10 md:flex-row md:gap-0 md:justify-between md:items-center md:h-full">
        <div className='sm:self-start md:w-1/2 md:order-2 md:self-center md:justify-self-end'>
        ...
        data-aos-once="true"
        data-aos-delay="700"
        className="flex justify-center sm:self-end md:w-1/2 md:order-1 md:jsutify-self-center">
